...
/**
 * The Feed before anything has come through: a system at rest, with the
    ...
    <Card tone="ghost" className="px-6 py-14 sm:py-20">
      <div className="mx-auto flex max-w-md flex-col items-center gap-7 text-center">
        <div className="flex flex-col items-center gap-3">
          <p className="text-label text-fg-muted">The Feed</p>
          <h2 className="text-2xl font-semibold tracking-tight text-fg sm:text-3xl">Quiet across the board.</h2>
